...
- **What it does:** evaluates deny-first shell policy, blocks protected edit/write paths, and optionally owns configured project-trust decisions. Shell control syntax always requires explicit confirmation; noninteractive asks fail closed.
