import type { TodoPublicItem } from "../../../../src/todo-contracts/contract.ts";
import { NO_TODO_CAPABILITIES, type TodoCapabilities, type TodoView } from "../../../../src/todo-contracts/provider.ts";
