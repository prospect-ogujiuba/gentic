---
description: Create or update a root-owned Gentic prompt template
...
1. Inspect existing `prompts/*.md` package resources.
2. Choose a kebab-case filename: `prompts/<name>.md`.
