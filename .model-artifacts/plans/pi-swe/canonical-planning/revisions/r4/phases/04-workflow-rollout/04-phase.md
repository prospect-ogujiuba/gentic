...
Nine pi-swe skills, one explicit guarded completion action, README, end-to-end scenarios, resource/document assertions, migration guidance/helpers justified by prior domain APIs, and final verification. No hidden autonomous implementation or generic workflow engine.

## Subphases

- `04.01` Planning and plan-review skill contracts
- `04.02` Execution, verification, review, and finalize skill contracts
- `04.03` Atomic contract completion and status projection
- `04.04` Migration, scenarios, hardening, and final verification
...
- Canonical completion is an atomic machine-state transition with stable filenames and readable status output.
