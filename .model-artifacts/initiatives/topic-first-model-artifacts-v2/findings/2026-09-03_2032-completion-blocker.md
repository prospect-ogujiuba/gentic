...
Affected artifact: `.model-artifacts/initiatives/topic-first-model-artifacts-v2/plans/revisions/r3/contracts.json`
...
Return to `/skill:swe-plan` to reconcile `.model-artifacts/initiatives/topic-first-model-artifacts-v2/plans/revisions/r3/contracts.json` with the completion schema, produce and approve a new immutable plan revision if required, then rerun verification/review identities as directed by that revision.
